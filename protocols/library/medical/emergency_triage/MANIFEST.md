# Emergency Triage Intake — Behavioral Manifest

**Pack ID:** emergency_triage
**Category:** medical
**Version:** 1.0
...
Governs the intake and acuity classification of an emergency department triage assessment — capturing the chief complaint, vital signs, mechanism of injury or illness onset, relevant medical history, and immediate clinical presentation to produce an emergency triage profile with acuity classification and immediate action requirements.

Emergency triage is the most time-critical clinical intake. The triage assessment determines the order in which patients receive care when resources are limited. An undertriaged patient — assigned a lower acuity level than their condition warrants — faces delayed treatment for a potentially life-threatening condition. An overtriaged patient consumes resources needed for higher-acuity patients. The intake supports accurate acuity classification based on objective clinical findings.
...
---
*Emergency Triage Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
