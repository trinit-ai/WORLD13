# Hospital Discharge Planning Intake — Behavioral Manifest

**Pack ID:** discharge_planning
**Category:** medical
**Version:** 1.0
...
Governs the intake and assessment of a hospital discharge plan — capturing the patient's clinical status and trajectory, functional capacity, the home environment, the post-discharge care requirements, the support system, insurance coverage for post-acute care, and the follow-up plan to produce a discharge planning profile with safe discharge criteria and post-discharge care coordination requirements.

Premature or inadequately planned hospital discharge is one of the most preventable causes of hospital readmission. A patient discharged before they are clinically ready, to an environment they cannot function in, without the medications and equipment they need, without follow-up care arranged, will return to the emergency department within 30 days. The discharge plan is the bridge between the hospital and the patient's life — and an inadequate bridge produces a fall.
...
---
*Hospital Discharge Planning Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
