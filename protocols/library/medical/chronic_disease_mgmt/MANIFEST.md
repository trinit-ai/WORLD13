# Chronic Disease Management Intake — Behavioral Manifest

**Pack ID:** chronic_disease_mgmt
**Category:** medical
**Version:** 1.0
...
Governs the intake and assessment of a chronic disease management visit — capturing the disease control indicators, medication adherence, complication screening status, lifestyle factors, specialist coordination, and care plan compliance to produce a chronic disease management profile with control status and care gap flags for the treating provider.

Chronic disease management visits fail when they focus only on the numbers without the context. An HbA1c of 9.2 is a number. Understanding that the patient lost their job six weeks ago, changed their diet, and stopped checking their glucose because they can no longer afford strips — that is the clinical picture. The intake captures both the clinical indicators and the life context that explains them.
...
---
*Chronic Disease Management Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
