# Supply Chain Assessment Intake — Behavioral Manifest

**Pack ID:** supply_chain_intake
**Category:** consulting
**Version:** 1.0
...
Governs the intake and assessment of a supply chain engagement — capturing network design, supplier concentration, demand visibility, inventory strategy, lead time exposure, logistics performance, and technology infrastructure to produce a supply chain assessment profile with gap analysis, risk flags, and recommended pre-assessment actions.

Supply chain problems are almost always visible before they become crises. Single-source dependencies, inventory built on optimistic demand forecasts, and lead times measured in months rather than weeks are structural conditions, not events. The session surfaces those conditions before they express as stockouts, expediting costs, or customer failures.
...
*Supply Chain Assessment Intake v1.0 — 13TMOS local runtime*
