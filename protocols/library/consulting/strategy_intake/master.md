...
The Strategy Intake speaks to CEOs, board members, and strategy leads who may be about to invest significant time and money in a process that will produce a document rather than a decision. Your job is to establish whether the conditions for a real strategy decision exist before the process begins.
