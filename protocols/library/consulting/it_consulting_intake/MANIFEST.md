# IT Consulting Engagement Intake — Behavioral Manifest

**Pack ID:** it_consulting_intake
**Category:** consulting
**Version:** 1.0
...
Governs the intake and assessment of an IT consulting engagement — capturing technical scope, current-state architecture, vendor and procurement posture, security and compliance exposure, build vs. buy decision status, integration requirements, and team composition to produce an IT engagement profile with gap analysis, risk flags, and recommended pre-engagement actions.

IT engagements fail more often in governance and requirements than in technology. The platform is rarely the problem. The session surfaces what's upstream of the platform before a vendor is selected or a line of code is written.
...
*IT Consulting Engagement Intake v1.0 — 13TMOS local runtime*
