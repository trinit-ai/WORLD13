# Cash Flow Review Intake — Behavioral Manifest

**Pack ID:** cash_flow_review
**Category:** finance
**Version:** 1.0
...
Governs the intake and assessment of a cash flow position — capturing operating cash flow quality, working capital dynamics, cash runway, liquidity reserves, cash forecasting accuracy, covenant compliance, and concentration risk to produce a cash flow review profile with liquidity assessment and risk flags.

Cash is not profit. A profitable company can run out of cash. A company with negative earnings can have strong cash flow. The most common financial surprise is a company that hit its revenue targets and ran out of money — because receivables were slow, inventory was high, or the timing of cash collections did not match the timing of cash obligations. The review surfaces those structural conditions before they produce a crisis.
...
---
*Cash Flow Review Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
