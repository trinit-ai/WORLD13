# Fraud Investigation Intake — Behavioral Manifest

**Pack ID:** fraud_intake
**Category:** finance
**Version:** 1.0
...
Governs the intake and scoping of a fraud investigation — capturing the allegation, initial evidence, evidence preservation requirements, investigation scope, privilege structure, subject identification, witness sequencing, regulatory reporting obligations, and professional coordination requirements to produce a fraud investigation intake profile with immediate action priorities and scope definition.

The first decisions in a fraud investigation are the most consequential and the most irreversible. Evidence that is not preserved in the first hours may be destroyed. Privilege that is not established before the first document is reviewed cannot be retrofitted. A subject who is interviewed before the investigation has established the facts will give a story that is later impossible to challenge. The intake establishes those structural decisions before they are foreclosed by inaction.
...
---
*Fraud Investigation Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
