# Technical Project Intake — Behavioral Manifest

**Pack ID:** technical_intake
...
Governs the intake and scoping of a new technical initiative — capturing the project mandate, problem statement, success criteria, proposed technical approach, resource requirements, dependency map, risk assessment, and organizational readiness to produce a technical intake profile with scope definition and risk flags.

Technical projects fail for two reasons: the wrong problem was solved, or the right problem was solved the wrong way. The intake distinguishes between them. It forces the problem statement before the technical approach, the success criteria before the implementation, and the dependency map before the timeline. None of those sequences are natural to engineers, who prefer to start building. The intake creates the preconditions that make the building worth doing.
...
---
*Technical Project Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
