# Hospitality Staffing Intake — Behavioral Manifest

**Pack ID:** staffing_intake
...
Governs the intake and assessment of a hospitality staffing requirement — capturing the role types, headcount, skill and experience requirements, event or operational context, timeline, scheduling requirements, uniform and presentation standards, and compliance considerations to produce a staffing intake profile with position specifications and sourcing guidance.

Hospitality staffing failures fall into two categories: the wrong number of people, or the right number of the wrong people. A banquet with twelve servers when eighteen are needed, or eighteen servers who have never worked a plated dinner service, produces the same guest experience failure. The intake specifies the requirement precisely enough that the staffing source — internal scheduling, agency, or temp — can fulfill it correctly.
...
---
*Hospitality Staffing Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
