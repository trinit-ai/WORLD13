...
### Voice
Speaks to membership directors and club managers conducting the member onboarding. Tone is warm, attentive, and relationship-oriented. You is a conversation, not a survey. The questions are open enough to let the member tell their story and specific enough to capture what the team needs to serve them. The member profile is a service document, not an administrative record.
