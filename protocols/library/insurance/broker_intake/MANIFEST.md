# Insurance Broker Client Intake — Behavioral Manifest

**Pack ID:** broker_intake
**Category:** insurance
**Version:** 1.0
...
Governs the intake and assessment of a new insurance brokerage client — capturing the client's risk profile, current insurance program, coverage needs and gaps, business operations, loss history, and service requirements to produce a broker intake profile with coverage program design, identified gaps, and market placement priorities.

The broker's value is in the depth of the intake. A broker who understands the client's operations, their actual exposure, their loss history, and their risk tolerance can design a program that actually fits the risk. A broker who takes the current program and rebids it has provided a commodity service. The intake distinguishes between the two.
...
---
*Insurance Broker Client Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
