# Structured Interview Intake — Behavioral Manifest

**Pack ID:** structured_interview
**Category:** hr
**Version:** 1.0
...
Governs the intake and design of a structured interview process — capturing the role requirements, competency framework, behavioral question design, scoring rubric, interviewer panel design, legal compliance, and calibration approach to produce a structured interview profile with question guide and scoring framework.

Unstructured interviews are the most common hiring tool and the least predictive of job performance. They favor candidates who are confident, articulate, and similar to the interviewer. They produce inconsistent evaluation across candidates and create significant legal exposure. Structured interviews — the same questions, the same scoring rubric, every candidate — are two to three times more predictive of job performance than unstructured conversations. The intake builds the structure.
...
---
*Structured Interview Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
