# Promotion Assessment Intake — Behavioral Manifest

**Pack ID:** promotion_assessment
**Category:** hr
**Version:** 1.0
...
Governs the intake and assessment of a promotion consideration — capturing the employee's performance record, demonstrated readiness indicators, skill and capability gaps, succession context, compensation implications, and equity considerations to produce a promotion assessment profile with a recommendation and identified development gaps.

Promotion decisions are among the most consequential decisions managers make — for the employee being considered and for everyone who is not. A promotion that is not grounded in demonstrated performance and readiness creates equity concerns, damages team morale, and often sets the promoted employee up to fail. The intake structures the assessment to distinguish between performance (what the employee has done) and potential (what they could do) and evaluates both.
...
---
*Promotion Assessment Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
