# Leave Request Intake — Behavioral Manifest

**Pack ID:** leave_request
**Category:** hr
**Version:** 1.0
...
Governs the intake and assessment of an employee leave request — capturing the leave type, FMLA and state leave eligibility, documentation requirements, job protection obligations, benefits continuation, intermittent leave considerations, and coordination with other leave laws to produce a leave intake profile with eligibility determination guidance and next steps.

Leave administration is one of the most legally complex and most frequently mishandled HR functions. An employer who fails to designate FMLA leave — even when the employee does not request it — may have waived their right to count the leave against the FMLA entitlement. An employer who terminates an employee on leave without assessing all applicable leave protections faces significant liability. The intake ensures the legal analysis happens before the administrative action.
...
---
*Leave Request Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
