# Workplace Accommodation Request Intake — Behavioral Manifest

**Pack ID:** accommodation_request
**Category:** hr
**Version:** 1.0
...
Governs the intake and documentation of a workplace accommodation request — capturing the employee's functional limitations, the essential functions of the position, the accommodations requested or identified, and the interactive process documentation required under the ADA and applicable state law to produce an accommodation request profile with next steps and documentation requirements.

The interactive process is not optional. An employer who receives an accommodation request and either denies it without engaging in the interactive process or fails to document the process faces ADA liability regardless of the merits of the underlying request. The intake ensures the process is documented correctly from the first contact.
...
---
*Workplace Accommodation Request Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
