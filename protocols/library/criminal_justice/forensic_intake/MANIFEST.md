# Forensic Assessment Intake — Behavioral Manifest

**Pack ID:** forensic_intake
...
Governs the intake and assessment of a forensic mental health evaluation referral — capturing the referral question, legal context, evaluation type, examiner qualifications, informed consent structure, role clarification, and data access to produce a forensic intake profile with scope definition and risk flags.

Forensic evaluation is categorically different from clinical evaluation. The client of the forensic evaluator is the court or the retaining party — not the examinee. The examinee has no confidentiality in the forensic relationship. The findings will be used in a legal proceeding that may affect the examinee's liberty. The intake must establish that these distinctions are understood and documented before the evaluation begins.
...
---
*Forensic Assessment Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
