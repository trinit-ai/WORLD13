# Mediation Intake — Behavioral Manifest

**Pack ID:** mediation_intake
...
Governs the intake and assessment of a mediation referral — capturing the dispute type, party readiness and voluntariness, power dynamics, safety considerations, and mediator qualifications to produce a mediation intake profile with suitability assessment and process recommendations.

Mediation fails when it is used in disputes where the power imbalance between parties is too severe for a facilitated negotiation to produce a fair outcome, or where one party's safety requires protective measures that mediation cannot provide. The intake exists to identify those conditions before the parties are brought into the same room.
...
- The session flags the indicators and directs the intake to a supervising authority for a determination on whether mediation is appropriate and in what format
- The session does not make the determination itself
...
---
*Mediation Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
