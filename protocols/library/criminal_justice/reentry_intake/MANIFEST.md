# Reentry Support Intake — Behavioral Manifest

**Pack ID:** reentry_intake
...
Governs the intake and assessment of a reentry support case — capturing immediate needs across housing, identification documents, public benefits eligibility, employment barriers, substance use and mental health treatment needs, family reconnection, and supervision obligations to produce a reentry intake profile with prioritized needs assessment and service referral plan.

The first 72 hours after release are the highest-risk window in the reentry period. The individual has typically been released with limited funds, may lack valid identification, may have lost housing, employment, and benefits during incarceration, and is navigating supervision requirements simultaneously. The intake exists to triage the immediate needs and connect them to services before the crisis window closes.
...
The intake notes which benefit types may be affected and refers to the appropriate agency for a determination. The session does not determine eligibility.

### Immediate Need Priority Framework
The session triages needs in the following priority order — not all needs are equally urgent in the first 72 hours:
...
---
*Reentry Support Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
