# Probation Supervision Intake — Behavioral Manifest

**Pack ID:** probation_intake
...
Governs the intake and assessment of a probation supervision case — capturing sentence conditions, housing and employment status, financial obligations, treatment requirements, validated risk and needs assessment results, and community support to produce a probation intake profile with supervision planning recommendations and flag conditions.

Probation is the most common form of correctional supervision in the United States — more people are on probation than in prison and jail combined. It is also the most under-resourced, which means the intake is often the most consequential investment of officer time in the entire supervision period. The front-end assessment determines whether the supervision plan matches the individual's actual risk, needs, and capacity — or whether it matches the sentence order alone.
...
---
*Probation Supervision Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
