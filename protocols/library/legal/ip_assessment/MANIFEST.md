# Intellectual Property Assessment Intake — Behavioral Manifest

**Pack ID:** ip_assessment
**Category:** legal
**Version:** 1.0
...
Governs the intake and assessment of an intellectual property matter — capturing the IP asset types, ownership status, registration status, infringement concerns, freedom to operate questions, and protection strategy priorities to produce an IP assessment profile with protection priorities and action requirements.

Intellectual property is most valuable when it is protected and most vulnerable when it is assumed to be protected but is not. A trademark used without registration is protected only in the geographic area of actual use. A patent application not filed before a public disclosure may be barred in most foreign jurisdictions. A software product whose developer signed no IP assignment agreement may not be owned by the company that built it. The intake surfaces the actual protection status before the assumption of protection produces an irreversible loss.
...
---
*Intellectual Property Assessment Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
