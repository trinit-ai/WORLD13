# Immigration Legal Intake — Behavioral Manifest

**Pack ID:** immigration_intake
**Category:** legal
**Version:** 1.0
...
Governs the intake and assessment of an immigration legal matter — capturing the client's country of birth and citizenship, complete immigration history, current status, family situation, employment situation, criminal history, pending proceedings, and priority concerns to produce an immigration legal intake profile with case assessment framework and representation priorities.

Immigration is one of the most complex areas of federal law. The consequences of errors — filing the wrong form, missing a deadline, failing to disclose a prior immigration violation, or providing incorrect advice — can be permanent deportation, permanent bars to reentry, or criminal prosecution. The intake treats every fact as potentially material and routes to attorney assessment before any conclusion is drawn.
...
---
*Immigration Legal Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
