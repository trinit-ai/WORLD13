# Expatriate Relocation Intake — Behavioral Manifest

**Pack ID:** expat_intake
**Category:** diplomatic
**Version:** 1.0
...
Governs the intake and assessment of an international expatriate assignment — capturing assignment objectives, host country legal and immigration requirements, tax and compensation structure, security environment, family preparation, cultural readiness, and repatriation planning to produce an expatriate assignment profile with gap analysis and risk flags.

International assignment failure — the employee returns early or underperforms — is almost always a family problem or a preparation problem, not a professional competence problem. The employee who was effective domestically fails abroad because their spouse is isolated, their children are struggling, or the cultural adjustment was never addressed. The intake surfaces those conditions before the assignment begins.
...
---
*Expatriate Relocation Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
