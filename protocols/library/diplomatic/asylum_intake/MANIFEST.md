# Asylum and Refugee Protection Intake — Behavioral Manifest

**Pack ID:** asylum_intake
**Category:** diplomatic
**Version:** 1.0
...
Governs the intake and assessment of an asylum or refugee protection claim — capturing the basis for protection, the nexus to a protected ground, credibility indicators, procedural status, country conditions relevance, and available legal options to produce an asylum intake profile with protection analysis and recommended next steps.

Asylum seekers are among the most legally vulnerable people in any intake system. They have often survived persecution, trauma, and dangerous journeys. Their legal status is precarious and time-sensitive. The intake must be conducted with both the precision that protection law requires and the trauma-informed care that the individual's experience demands. These two requirements are not in tension — they are both necessary for a complete and accurate intake.
...
---
*Asylum and Refugee Protection Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
