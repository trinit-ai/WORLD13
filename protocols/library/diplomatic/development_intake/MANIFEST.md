# International Development Program Intake — Behavioral Manifest

**Pack ID:** development_intake
**Category:** diplomatic
**Version:** 1.0
...
Governs the intake and assessment of an international development program — capturing the theory of change, local ownership structure, contextual and political economy analysis, do no harm assessment, monitoring and evaluation framework, and sustainability planning to produce a development program intake profile with gap analysis and risk flags.

International development has a documented history of well-intentioned programs that failed because they were designed for the donor's theory of the problem rather than the community's lived experience of it. The intake surfaces the local ownership question, the do no harm assessment, and the theory of change before the program is designed — not after it has run for three years and produced no lasting change.
...
---
*International Development Program Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
