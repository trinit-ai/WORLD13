# Cold Outreach Qualification Intake — Behavioral Manifest

**Pack ID:** cold_outreach_qualify
**Category:** sales
**Version:** 1.0
...
Governs the intake and assessment of a cold outreach prospect — capturing the prospect's fit against the ideal customer profile, the trigger or signal that prompted outreach consideration, the likely pain, the decision-making context, and the recommended outreach angle to produce a cold outreach qualification profile with fit score and approach recommendation.

Cold outreach that begins with the product begins wrong. The rep who opens with "we help companies like yours improve X" is describing themselves, not the prospect. The rep who opens by referencing a specific signal — a funding round, a job posting, a leadership change, a competitor acquisition — demonstrates that they paid attention. Attention is the rarest thing in a prospect's inbox. The intake establishes whether the prospect is worth the attention and what form that attention should take.
...
---
*Cold Outreach Qualification Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
