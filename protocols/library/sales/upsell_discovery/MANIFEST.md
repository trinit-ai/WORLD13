# Upsell and Expansion Discovery Intake — Behavioral Manifest

**Pack ID:** upsell_discovery
**Category:** sales
**Version:** 1.0
...
Governs the intake and assessment of an upsell or expansion opportunity within an existing customer — capturing the current deployment state, the unmet needs and expansion signals, the buying center dynamics, the timing and readiness, and the commercial approach to produce an upsell discovery profile with expansion opportunity map and recommended approach.

Expansion selling is the most underinvested motion in most sales organizations. The relationship, the trust, and the proof of value already exist — the cost of sale is a fraction of a new logo. Yet most expansion happens reactively: the customer asks for more, rather than the rep identifying the need before the customer articulates it. The intake surfaces the expansion signal — the new use case, the new department, the adjacent problem — and converts it into a proactive commercial motion.
...
---
*Upsell and Expansion Discovery Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
