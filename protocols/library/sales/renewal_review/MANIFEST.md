# Renewal Review Intake — Behavioral Manifest

**Pack ID:** renewal_review
**Category:** sales
**Version:** 1.0
...
Governs the intake and assessment of an upcoming contract renewal — capturing the renewal health indicators, the customer's realized value and outcome achievement, the relationship and commercial status, the expansion opportunity within the account, and the risk factors to produce a renewal review profile with renewal strategy and expansion assessment.

A renewal that is managed only in the 90 days before expiry is a renewal that was managed too late. The customer's decision to renew is made continuously — every support interaction, every product release, every QBR, every moment the product does or does not deliver value is a vote cast in the renewal. The renewal review is not a separate process from customer success — it is the summary of whether customer success actually happened.
...
---
*Renewal Review Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
