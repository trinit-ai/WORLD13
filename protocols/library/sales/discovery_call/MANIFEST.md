# Discovery Call Intake — Behavioral Manifest

**Pack ID:** discovery_call
**Category:** sales
**Version:** 1.0
...
Governs the intake and documentation of a discovery call — capturing the prospect's current situation, the pain and its business impact, the decision-making process and stakeholders, the timeline, the budget context, and the competitive landscape to produce a discovery call profile with qualification assessment and next step recommendations.

Discovery is the most important call in the sales process and the one most commonly misunderstood. It is not a product demo with questions. It is a structured investigation into whether the prospect has a problem worth solving, whether they are willing to invest in solving it, and whether they will involve the right people to make a decision. The rep who does discovery well wins deals before the demo. The rep who skips discovery loses deals after the demo.
...
---
*Discovery Call Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
