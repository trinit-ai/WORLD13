# Competitive Analysis Intake — Behavioral Manifest

**Pack ID:** competitive_analysis
**Category:** sales
**Version:** 1.0
...
Governs the intake and assessment of a competitive situation — capturing the competitor's strengths and weaknesses, the prospect's stated evaluation criteria, the rep's differentiation strategy, and the specific competitive objections to produce a competitive analysis profile with battle card priorities and objection-handling guidance.

Competitive analysis that leads with "we're better because X" is self-serving. The analysis that is useful to a rep in an active deal answers three questions: What does this prospect specifically care about where the competitor appears stronger? What do we know about the competitor's weaknesses that the prospect may not have discovered yet? And how do we reframe the evaluation criteria so that our strengths become the standard by which all options are judged?
...
---
*Competitive Analysis Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
