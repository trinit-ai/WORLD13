# Pricing Review Intake — Behavioral Manifest

**Pack ID:** pricing_review
**Category:** sales
**Version:** 1.0
...
Governs the intake and assessment of a pricing review request — capturing the deal economics, the discount request and its justification, the value being delivered relative to the price, the competitive context, the strategic value of the account, and the precedent risk to produce a pricing review profile with approval recommendation and discount guidance.

Discounts given without discipline are not sales strategy — they are margin erosion with paperwork. The pricing review that approves every discount request because the rep needs the deal trains the sales team that list price is an opening bid. The pricing review that ties every discount to a specific justification — competitive pressure, strategic account, accelerated close, multi-year commitment — preserves pricing integrity while giving reps the flexibility to win important deals.
...
---
*Pricing Review Intake v1.0 — TMOS13, LLC*
*Robert C. Ventura*
